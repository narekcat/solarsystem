...
<div class="comment">
<p>Материаялов:<?=$materials_count;?>,
Комментариев:<?=$comments_count;?>,
Категорий:<?=$sections_count;?>,
Страниц:<?=$pages_count;?></p>
</div>

<p><strong>Самые популярные материалы</strong></p>
<div class="comment">
<?php foreach($popular_materials as $item):?>
<p><a href="<?=base_url()."materials/$item[material_id]";?>"><?=$item['title'];?></a>
(<?=$item['count_views'];?> просмотра (ов))</p>
<?php endforeach;?>
</div>

<p><strong>Свежие комментапии: </strong></p>
